...
import com.kojikoji.dao.OrderDao;
import com.kojikoji.domain.*;
import com.kojikoji.service.*;
...
public class OrderServiceImpl extends ServiceImpl<OrderDao, Orders> implements OrderService {
    ...
    public void submit(Orders orders) {
        ...
        List<ShoppingCart> cart = shoppingCartService.list(cartWrapper);
        ...
        if(addressBook == null){
            throw new CustomerException("用户地址有误，不能下单");
        }
        ...
        List<OrderDetail> orderDetails = cart.stream().map((item)->{
